...
;(function($, undefined){
    ...
    var HtmlCodeOrnament = {
        Language:{
            html:[
                {type:"label",color:"#3340ff",items:"pre|link|&gt;|&lt;|h1|h2|h3|h4|h5|script|select|option|title|meta|div|label|input|table|thead|tr|th|tbody|td"},
        ...
        beautifulCode:function (language) {
            ...
            $.each($pres,function (i,pre) {
                ...
                $code.html(newHtml);
                // console.log(newHtml);
                HtmlCodeOrnament.addTitle($code,preClass);
